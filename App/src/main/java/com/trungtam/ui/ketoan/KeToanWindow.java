...
public class KeToanWindow extends JFrame {

    public KeToanWindow() {
        setTitle("Kế Toán – Trung Tâm Đào Tạo");
        ...
        SidebarPanel sidebar = new SidebarPanel(UiTheme.KETOAN);
        sidebar.addSection("Tài chính");
        String[] titles = {
                "Thu Học Phí", "Hoàn Trả Học Phí", "Phát Học Bổng", "Báo Cáo Doanh Thu"
        };
        for (String t : titles) sidebar.addItem(t);

        JPanel[] panels = {
                new ThuHocPhiPanel(), new HoanTraHocPhiPanel(),
                new PhatHocBongPanel(), new BaoCaoDoanhThuPanel()
        };
    ...
    private JComponent buildTopbar() {
        ...
        JLabel title = new JLabel("Cổng kế toán");
        title.setFont(UiTheme.TITLE_M);
        title.setForeground(UiTheme.TEXT_PRIMARY);

        JLabel subtitle = new JLabel("Thu phí, hoàn trả, học bổng và báo cáo tài chính");
        ...
        JLabel badge = new JLabel("Kế toán");
        badge.setFont(UiTheme.CAPTION);
        badge.setOpaque(true);
        badge.setBackground(new Color(UiTheme.KETOAN.getRed(), UiTheme.KETOAN.getGreen(), UiTheme.KETOAN.getBlue(), 24));
        badge.setForeground(UiTheme.KETOAN);
