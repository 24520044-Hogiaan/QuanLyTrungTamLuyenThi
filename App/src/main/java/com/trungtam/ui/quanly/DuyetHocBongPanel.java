...
public class DuyetHocBongPanel extends JPanel {
    ...
    private static final String[] COT = {
            "Mã HB", "Học Viên", "Giá Trị", "Ngày Cấp", "Trạng Thái"
    };
    ...
    private JPanel buildTopBar() {
        ...
        JButton approveBtn = UiComponents.primaryButton("Xét duyệt", UiTheme.SUCCESS);
    ...
    private void loadSampleData() {
        tableModel.addRow(new Object[]{1, "Nguyễn An", "500,000 VND", "25/05/2026", "Đã nhận"});
    }
}
