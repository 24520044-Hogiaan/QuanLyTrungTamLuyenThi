...
public class DuyetChuyenLopPanel extends JPanel {
    ...
    private static final String[] COT = {
            "Mã YC", "Học Viên", "Lớp Cũ", "Lớp Mới", "Lý Do", "Ngày YC", "Trạng Thái"
    };
    ...
    private JPanel buildTopBar() {
        ...
        JLabel title = new JLabel("Duyệt Yêu Cầu Chuyển Lớp");
        ...
        JButton approveBtn = UiComponents.primaryButton("Chấp thuận", UiTheme.SUCCESS);
    ...
    private void loadSampleData() {
        tableModel.addRow(new Object[]{1, "Nguyễn An", "Lớp Toán 10A1", "Lớp Văn 11B1",
                "Trùng lịch học văn hóa trên trường", "25/05/2026", "Chờ duyệt"});
    }
}
