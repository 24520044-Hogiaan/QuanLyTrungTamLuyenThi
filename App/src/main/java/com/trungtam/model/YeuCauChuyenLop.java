...
public class YeuCauChuyenLop {
    ...
    public int getMaLopCu() { return maLopCu; }
    public void setMaLopCu(int maLopCu) { this.maLopCu = maLopCu; }

    public int getMaLopMoi() { return maLopMoi; }
    public void setMaLopMoi(int maLopMoi) { this.maLopMoi = maLopMoi; }
