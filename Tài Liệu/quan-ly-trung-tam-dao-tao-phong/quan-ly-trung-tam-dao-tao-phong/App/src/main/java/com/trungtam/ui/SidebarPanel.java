...
/**
 * Custom sidebar panel — white background, section headers, selected item
 * highlighted with a filled blue/green pill and white text (matching the
 * modern light-sidebar reference design).
 */
public class SidebarPanel extends JPanel {
    ...
    private class ItemRow extends JPanel {
        ...
        protected void paintComponent(Graphics g0) {
            ...
            if (selected) {
                // Filled pill with 6px margin on each side
                int margin = 8;
